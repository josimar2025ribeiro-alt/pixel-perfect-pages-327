...
function LandingPage() {
  ...
  return <main id="top">
    <header className="site-header"><div className="nav-wrap"><Logo/><nav className={menu ? "nav-links open" : "nav-links"}><a href="#como">Como funciona</a><a href="#exemplos">Exemplos</a><a href="#preco">Preço</a><a href="#faq">FAQ</a></nav><div className="nav-actions"><a href="https://login-biosite.lovable.app">Entrar</a><a className="btn lime compact" href="#preco">Começar agora</a><span className="flags">🇧🇷 🇺🇸 🇪🇸</span></div><button className="menu-button" aria-label="Abrir menu" onClick={() => setMenu(!menu)}>{menu ? <X/> : <Menu/>}</button></div></header>
